...
public class GameStateManager {
    private Stack<GameState> states; //set current state
    ...
    public void loop() {
        try{
            ...
            System.err.println("[GameStateManager]: Dude, GameState is Empty");
            System.exit(-1);
        }
    }
    public void render(Graphics graphics){
        try{
            ...
            System.err.println("[GameStateManager]: Error! GameState Empty.");
            System.exit(-1);
        }
    }
